...
#   
#   
#   File:   project-mcp-tools/tools/tool_manager.py
...
class tool_manager:
    ...
    def _run_in_subprocess( self, tool_name, kwargs ):
        ...
        text = get_process_text( result )
        return  contract_success( text ) if result.returncode == 0 else contract_error( text )
    ...
    def list_tools( self ) -> str:
        ...
        return  to_json( [ info.to_dict for info in self._registry.values( ) ] )
