...
A consumer project may use `Import:` headers pointing to `project-mcp-tools` docs via relative paths (e.g., `../../../../project-mcp-tools/docs/agent/workflow/index.md`). The `project-mcp-tools` project itself must never import from external projects.
